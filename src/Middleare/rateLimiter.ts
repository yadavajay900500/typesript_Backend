...
export const customRedisRateLimiter = async (req:IreqUser, res:Response, next:NextFunction) => {
  ...
  try {
    ...
    const record:any = await redisClient.get(req.ip);
    ...
    let data:any = JSON.parse(record);
